...
import { loadMarketItemContent } from '@/lib/market/market-content'
...
export async function generateMetadata({ params }: Props) {
  ...
  const [{ item }, content] = await Promise.all([
    ...
    loadMarketItemContent(id, locale),
  ])
  if (!item) return {}
  ...
  const ogImage = content?.images.card ?? `/images/market/item-${itemId}/og.jpg`
